     ...
     try
       {
        ...
        while(rs.next())
        {
            ...
            if(c!=null)
            jComboBox2.addItem(rs.getString("tpositon"));  
        }
       }catch(Exception e)
       {
...
{        String firstname = jTextField1.getText();
    ...
    {
        JOptionPane.showMessageDialog(this,"Some Field is  Empty.Please provide all Data","Update Student ",JOptionPane.ERROR_MESSAGE);
    }
    else
    {
        try
        {              
            ...
            {
                String sql = "update teacher set id = '"+id+"',firstname ='"+firstname+"' ,lastname='"+lastname+"',position ='"+position+"' ,age ='"+age+"' ,dob ='"+dob+"' ,contact = '"+contact+"',emailid='"+emailid+"',gender='"+gender+"',permanentaddress='"+permanentaddress+"',presentaddress='"+presentaddress+"' where id="+id+"";
                pst = con.prepareStatement(sql);
                pst.executeUpdate();
                JOptionPane.showMessageDialog(this,"Teacher Record Update Successfully","",JOptionPane.INFORMATION_MESSAGE);
           ...
           try
                {
                 ResultSet   rs=st.executeQuery("select * from teacher where id="+id+"");
                    ...
                    {
                       JOptionPane.showMessageDialog(this,"Teacher Record Not found ");
                        clearfield();
                    }
                }
                catch(Exception nf)
