    ...
    while(rs.next())
   {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Teacher ID", "First Name", "Last Name", "Position", "Age", "Date of Birth", "Contact No", "Email ID", "Gender", "Permanent Address", "Present Address"
            }
        ) {
        ...
        jLabel2.setText("Teacher Record");
...
public void TeacherPopupMenu(Frame frame)
    {
      ...
      delete.addActionListener(new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
        //JOptionPane.showMessageDialog(delete,"Delete one record Succesfully");
       // int cVal= JOptionPane.showConfirmDialog(delete, "Are you really wants to delete record ","",JOptionPane.OK_CANCEL_OPTION);
         //if(cVal==0)
        {
         deleteteacher();
        // new AddTeacher().show();
