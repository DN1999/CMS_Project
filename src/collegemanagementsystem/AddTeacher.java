  ...
  public void addPosition()
{
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("High Tower Text", 1, 42)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(102, 0, 102));
        jLabel1.setText("Add Teacher Record");
    ...
    else
    {
        try
        {
            ...
            {
                String sql = "insert into teacher(firstname,lastname,position,age,contact,dob,emailid,gender,permanentaddress,presentaddress) values('"+firstname+"','"+lastname+"','"+position+"','"+age+"','"+contact+"','"+dob+"','"+emailid+"','"+gender+"','"+permanentaddress+"','"+presentaddress+"')";
                st.executeUpdate(sql);
                JOptionPane.showMessageDialog(this,"Teacher Add Successfully","",JOptionPane.INFORMATION_MESSAGE);
                new Teacher().show();
